...
export class InitialMigration1688057943624 implements MigrationInterface {
    name = 'InitialMigration1688057943624'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "real_estate" ("id" SERIAL NOT NULL, "value" numeric NOT NULL DEFAULT '0', "size" integer NOT NULL, "sold" boolean NOT NULL DEFAULT false, "createdAt" date NOT NULL DEFAULT now(), "updatedAt" date NOT NULL DEFAULT now(), "addressId" integer, "categoryId" integer, CONSTRAINT "REL_44ae17efa35575b6a6f83b35ee" UNIQUE ("addressId"), CONSTRAINT "PK_8735a23fd5adc2afb18242894ff" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "schedules" ("id" SERIAL NOT NULL, "date" TIME NOT NULL, "hour" TIME NOT NULL, "userId" integer NOT NULL, "realEstateId" integer, CONSTRAINT "REL_ac3131bb922483053abebc5e9f" UNIQUE ("realEstateId"), CONSTRAINT "PK_7e33fc2ea755a5765e3564e66dd" PRIMARY KEY ("id"))`);
